...
int s21_div(s21_decimal value_1, s21_decimal value_2, s21_decimal *result) {
  *result = ONE_DIGIT_DECIMAL(0);
  ...
  int extra_exp = 0;
  dodicum div_dodicum = ONE_DIGIT_DODICUM(0);
  dodicum_div(value_1_dodicum, value_2_dodicum, &div_dodicum, &extra_exp);
  // TODO(M || V) = handle extra_exp and division by 0

  int error_code = denormalize(div_dodicum, result);
